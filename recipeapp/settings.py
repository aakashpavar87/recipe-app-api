...
SECRET_KEY = "django-insecure-3pkf7454q(5*gdqbbr0^vvk2^vnttt87^_hpnanbz!pogirxqy"
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "REST api for food enthusiasts which is built in most popular rest framework of python.",
    "VERSION": "1.0.0",
